...
public class FaceMeshResultGlRenderer implements ResultGlRenderer<FaceMeshResult> {
  ...
  private static final float[] RIGHT_EYE_COLOR_OFF = new float[] {1f, 0.2f, 0.2f, 1f};
  private static final float[] RIGHT_EYE_COLOR_ON = new float[] {0.2f, 1f, 0.2f, 1f};
  private static final int RIGHT_EYE_THICKNESS = 3;
  private static final float[] RIGHT_EYEBROW_COLOR_OFF = new float[] {1f, 0.2f, 0.2f, 1f};
  private static final float[] RIGHT_EYEBROW_COLOR_ON = new float[] {0.2f, 1f, 0.2f, 1f};
  private static final int RIGHT_EYEBROW_THICKNESS = 8;
  private static final float[] LEFT_EYE_COLOR_OFF = new float[] {1f, 0.2f, 0.2f, 1f};
  private static final float[] LEFT_EYE_COLOR_ON = new float[] {0.2f, 1f, 0.2f, 1f};
  private static final int LEFT_EYE_THICKNESS = 3;
  private static final float[] LEFT_EYEBROW_COLOR_OFF = new float[] {1f, 0.2f, 0.2f, 1f};
  private static final float[] LEFT_EYEBROW_COLOR_ON = new float[] {0.2f, 1f, 0.2f, 1f};
  ...
  private static final float[] LIPS_COLOR_OFF = new float[] {1f, 0.2f, 0.2f, 1f};
  private static final float[] LIPS_COLOR_ON = new float[] {0.2f, 1f, 0.2f, 1f};
